...
这是一个 AI Skill——安装后，你的 AI 助手就能查询金谷园饺子馆的信息：在哪吃、几点开门、现在排不排队、午饭后几点去更稳、能不能外卖、生饺子怎么煮、Wi-Fi 密码是什么。还能直接帮你在美团上排队取号。
...
| 查询餐段参考 | 参考午市/晚市大概几点开始排、几点后缓下来 | "明天中午几点去比较稳？" |
